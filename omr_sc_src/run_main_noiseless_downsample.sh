...
feature_dir="../features/noiseless_downsample"
proj_dir="../proj_images/noiseless_downsample"
option_dir="./options_downsample_noiseless"
init_dir="../mom_lsq_init/noiseless_downsample"
results_dir="./results_noiseless_downsample"

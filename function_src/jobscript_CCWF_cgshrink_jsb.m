function [ denoised_coeff, eigims, egval, num_eigs, C_FB] = jobscript_CCWF_cgshrink_jsb(index, w_f_rad, CTF_rad_all, basis, sample_points,  mean_coeff, coeff_pos_k, noise_v)
...
% Tejal Jan 2016
% Mona: I added C_FB as the output. Originally in the cwf_denoise package, C_FB was not passed as an output.
